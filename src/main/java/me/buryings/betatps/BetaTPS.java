...
public final class BetaTPS extends JavaPlugin implements Listener {
    ...
    private void loadConfig() {
        ...
        // copies ascii text - not working/appearing in config will fix yes
        getConfig().options().header("# ───────────────────────────────────────────────────────────────────────────────────────────────────────────────  #\n" +
                ...
                "  #  ─████████████████─██████████████─────██████─────██████──██████────────██████─────██████─────────██████████████─ #\n" +
                "  #  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────── #\n" +
                "  #  Made by: Buryings (Bury#0001 on discord)\n" +
                "  # ─────────────────────────────────────────────────────────────────────────────────────────────────────────────── #\n" +
                "  #  A simple TPS Counter plugin which sends the server's TPS to a player in a message using /btps #\n" +
                "  #  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────── #");
        getConfig().options().copyHeader(true);
    }
    /* public void saveConfig() {
        this.saveConfig();
        System.out.println("[BETA TPS]: Config has saved!");
